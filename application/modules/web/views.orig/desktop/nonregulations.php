            ...
            <div class="col-lg-8 col-md-7 col-sm-12">
                ...
                <?php if ($nonregulations) { ?>
                    <div class="row">
                        <!-- post -->
                        <?php
                        foreach ($nonregulations as $nondoc) {
                            ?>
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body" >
                                        <div class="d-flex mb-1 text-decoration-none">

                                            <!-- image -->
                                            <div style="width:100px;" class="text-center bg-light rounded bg-cover lazy" >
                                            ...
                                            <div class="col">
                                                ...
                                                <span class="fs-6 fw-light" >
                                                    <a href="<?php echo site_url('web/nonregulations/read/' . $nondoc->groups . '/' . $nondoc->slug) ?>" class="text-primary-emphasis link-dark">
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href = "<?php echo site_url('web/nonregulations/read/' . $nondoc->groups . '/' . $nondoc->slug) ?>" class ="btn btn-success btn-soft btn-sm"><i class="fi fi-bookmark"></i>  Baca</a>
                                            <span class = "btn btn-info btn-soft text-primary btn-sm"><i class="fi fi-eye"></i> <?php echo $nondoc->viewed ?> </span>
                                            <span class = "btn btn-info btn-soft text-primary btn-sm"><i class="fi fi-arrow-download"></i> <?php echo $nondoc->downloaded ?> </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
