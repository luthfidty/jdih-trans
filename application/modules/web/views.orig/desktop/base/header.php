...
<html lang="en" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta charset="UTF-8">
            ...
            <link rel="preload" href="<?php echo site_url('assets/web/' . $device . '/fonts/flaticon/Flaticon.woff2') ?>" as="font" type="font/woff2" crossorigin/>
            <link rel="stylesheet" href="<?php echo site_url('assets/web/' . $device . '/css/core.min.css') ?>"/>
            <link rel="stylesheet" href="<?php echo site_url('assets/web/' . $device . '/css/vendor_bundle.min.css') ?>"/>
