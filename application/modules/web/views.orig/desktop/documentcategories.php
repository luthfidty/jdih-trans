                                ...
                                <div class="card">
                                    <div class="card-body" >
                                        <div class="d-flex mb-1 text-decoration-none">
                                            ...
                                            <div class="col">
                                                ...
                                                <span class="fs-6 fw-light" >
                                                    <a href="<?php echo site_url('web/documents/read/' . $doc->slug) ?>" class="text-primary-emphasis link-dark">
                                                        <?php echo $doc->title ?>
                                                    </a>
                                                </span>
                                            </div>
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href = "<?php echo site_url('web/documents/read/' . $doc->slug) ?>" class ="btn btn-success btn-soft btn-sm"><i class="fi fi-bookmark"></i>  Baca</a>
                                            <span class = "btn btn-info btn-soft text-primary btn-sm"><i class="fi fi-eye"></i> <?php echo $doc->viewed ?> </span>
                                            <span class = "btn btn-info btn-soft text-primary btn-sm"><i class="fi fi-arrow-download"></i> <?php echo $doc->downloaded ?> </span>
                                        </div>
                                    </div>
                                </div>
                            </div>
