...
class Documenttypes_model extends CI_Model {
    ...
    function total_rows($q = NULL) {
        $this->db->like('id', $q);
        $this->db->or_like('documenttype', $q);
...
/* End of file Docymenttypes_model.php */
/* Location: ./application/models/Docymenttypes_model.php */
