        ...
        <div class="p-4 border-b border-gray-200 flex flex-wrap justify-between items-center gap-4">
            ...
            <div class="flex flex-wrap items-center">
                ...
                if (in_array('create', $rolelist)) {
                    echo $this->myacl->_btnCreate(site_url('app/documentcategories/create'), "Tambah");
                }
                ?>
            </div>
            ...
            <!-- Form pencarian -->
            <form action="<?php echo site_url('app/documentcategories/index'); ?>" method="get"
            ...
            <table class="min-w-full text-sm text-left border-t border-gray-200 table-fixed">
                <thead class="bg-gray-100 text-gray-700 sticky top-0 z-20">
                    <tr>
                        ...
                        <th class="px-4 py-2 border-b">Jenis / Kategori</th>
                        <th class="px-4 py-2 border-b">Akronim / Singkatan</th>
                        <th class="sticky right-0 z-30 bg-gray-100 px-4 py-2 border-b text-center w-[120px]">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    <?php foreach ($documentcategories_data as $documentcategories): ?>
                        <tr class="border-b hover:bg-gray-50">
                            <td class="sticky left-0 z-10 bg-white px-4 py-2 w-[60px]"><?php echo ++$start ?></td>
                            <td class="px-4 py-2"><?php echo $documentcategories->category ?></td>
                            <td class="px-4 py-2"><?php echo $documentcategories->acronym ?></td>
                            <td class="sticky right-0 z-10 bg-white px-4 py-2 text-center w-[120px]">
                                <div class="flex justify-center gap-2">
                                    <?php if (in_array('update', $rolelist)) { ?>
                                        <a href="<?php echo site_url('app/documentcategories/update/' . $documentcategories->id) ?>"
                                    ...
                                    <?php if (in_array('delete', $rolelist)) { ?>
                                        <a href="<?php echo site_url('app/documentcategories/delete/' . $documentcategories->id) ?>"
