        ...
        <div class="p-4 border-b border-gray-200 flex flex-wrap justify-between items-center gap-4">
            ...
            <div class="flex flex-wrap items-center">
                ...
                if (in_array('create', $rolelist)) {
                    echo $this->myacl->_btnCreate(site_url('app/nondocumentcategories/create'), "Tambah");
                }
                ?>
            </div>
            ...
            <!-- Form pencarian -->
            <form action="<?php echo site_url('app/nondocumentcategories/index'); ?>" method="get"
                class="flex gap-2 items-center">
                <input type="text" name="q" class="border border-gray-300 rounded px-2 py-1 text-sm"
                    value="<?php echo $q; ?>" placeholder="Cari...">
                <?php if ($q !== '') { ?>
                    <a href="<?php echo site_url('app/nondocumentcategories'); ?>"
            ...
            <table class="min-w-full text-sm text-left border-t border-gray-200 table-fixed">
                <thead class="bg-gray-100 text-gray-700 sticky top-0 z-20">
                    <tr>
                        ...
                        <th class="px-4 py-2 border-b">Kunci Kategori</th>
                ...
                <tbody>
                    <?php foreach ($nondocumentcategories_data as $nondocumentcategory): ?>
                        <tr class="border-b hover:bg-gray-50">
                            <td class="sticky left-0 z-10 bg-white px-4 py-2 w-[60px]"><?php echo ++$start ?></td>
                            <td class="px-4 py-2"><?php echo $nondocumentcategory->group_key ?></td>
                            <td class="px-4 py-2"><?php echo $nondocumentcategory->group_name ?></td>
                            <td class="sticky right-0 z-10 bg-white px-4 py-2 text-center w-[120px]">
                                <div class="flex justify-center gap-2">
                                    <?php if (in_array('update', $rolelist)) { ?>
                                        <a href="<?php echo site_url('app/nondocumentcategories/update/' . $nondocumentcategory->id) ?>"
                                    ...
                                    <?php if (in_array('delete', $rolelist)) { ?>
                                        <a href="<?php echo site_url('app/nondocumentcategories/delete/' . $nondocumentcategory->id) ?>"
